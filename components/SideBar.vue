  ...
  <div class="side-bar max-md:side-bar-bottom max-lg:side-bar-collapse">
    ...
    >
      ...
      <div class="h-[60px] flex items-center justify-between max-md:hidden">
        <a
          href="#"
          class="flex justify-center items-center gap-3 max-lg:w-full"
        >
          <img
            :src="
          ...
          />
          <p
            class="text-xl font-bold text-white max-lg:hidden line-clamp-1 tracking-wide"
          >
            {{
      ...
      <!-- Navigation -->
      <div class="flex flex-col gap-4 nav-group">
        <!-- Overview -->
        <NuxtLink :to="{ name: 'overview' }" class="nav-link">
          <svg
        ...
        <!-- Articles -->
        <NuxtLink :to="{ name: 'articles' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Diseases -->
        <NuxtLink :to="{ name: 'diseases' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Pesticide -->
        <NuxtLink :to="{ name: 'pesticides' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
